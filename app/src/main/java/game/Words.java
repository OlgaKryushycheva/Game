...
/**
 * Сховище слів із короткими підказками для раундів гри.
 * Назва класу використовує лише ASCII-символи, щоб уникнути розбіжностей
 * між назвою файлу та класу на різних ОС.
 */
public class Words {
